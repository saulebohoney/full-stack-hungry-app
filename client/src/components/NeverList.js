...
export class NeverList extends React.Component {
  ...
  handleClick(e) {
    e.preventDefault();
    const id = this.props.restaurantProps[0].id;
  ...
  render() {
    ...
    return (
      <div className="buttons">
        <button type="button" id="button1" onClick={(e) => this.handleYes(e)}>Yes, take me there!
        </button>
...
export const mapStateToProps = (state) => ({nevers: state.nevers, restaurant: state.restaurants, city: state.city});
